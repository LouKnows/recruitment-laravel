					...
					<div class="card info">
						...
						<div class="personal_data">
							...
							<div class="suffix_name">
								...
								<input type="text" name="personal_detail[suffix_name]">
							</div>
							<div class="mobile_1">
								<div>Mobile 1</div>
								<input type="text" name="personal_detail[mobile_1]">
							</div>
							<div class="mobile_2">
								<div>Mobile 2</div>
								<input type="text" name="personal_detail[mobile_2]">
							</div>
							<div class="email">
								<div>Email</div>
								<input type="email" name="personal_detail[email]">
							</div>
							<div class="age_gender">
								<div class="age">
									<div>Age</div>
									<input type="number" name="personal_detail[age]">
								</div>
								<div class="gender">
									<div>Gender</div>
									<select name="personal_detail[gender]">
							...
							<div class="birthday">
								<div>Birthday</div>
								<input type="date" name="personal_detail[birthday]">
							</div>
							<div class="civil_status">
								<div>Civil Status</div>
								<select name="personal_detail[civil_status]">
							...
							<div class="religion">
								<div>Religion</div>
								<input type="text" name="personal_detail[religion]">
							</div>
							<div class="weight_height">
								<div class="weight">
									<div>Weight</div>
									<input type="text" name="personal_detail[weight]">
								</div>
								<div class="height">
									<div>Height</div>
									<input type="text" name="personal_detail[height]">
								</div>
							</div>
							<div class="city_address">
								<div>City Address</div>
								<input type="text" name="personal_detail[city_address]">
							</div>
							<div class="province_address">
								<div>Provincial Address</div>
								<input type="text" name="personal_detail[province_address]">
							</div>
							<div class="father_name">
								<label>Father's Name</label>
								<input type="text" name="personal_detail[father_name]">
							</div>
							<div class="mother_name">
								<label>Mother's Name</label>
								<input type="text" name="personal_detail[mother_name]">
							</div>
						</div>
					</div>
					...
					<div class="card info">
						...
						<div class="spouse_info">
							<div class="spouse_fname">
								<div>First Name</div>
								<input type="text" name="spouse[0][first_name]">
							</div>
							<div class="spouse_mname">
								<div>Middle Name</div>
								<input type="text" name="spouse[0][middle_name]">
							</div>
							<div class="spouse_lname">
								<div>Last Name</div>
								<input type="text" name="spouse[0][last_name]">
							</div>
							<div class="spouse_bday">
								<div>Birthday</div>
								<input type="date" name="spouse[0][birthday]">
							</div>
							<div class="spouse_occupation">
								<div>Occupation</div>
								<input type="text" name="spouse[0][occupation]">
							</div>
							<div class="spouse_contact">
								<div>Contact Number</div>
								<input type="text" name="spouse[0][contact_no]">
							</div>
							<div class="spouse_address">
								<div>Address</div>
								<input type="text" name="spouse[0][address]">
							</div>
						</div>
